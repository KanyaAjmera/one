      ...
      <div className="relative z-10 flex-1 flex flex-col w-full">
        ...
        <div className="border-b border-white/10 bg-black/30 backdrop-blur-sm sticky top-16 z-30">
          <div className="max-w-5xl mx-auto px-4 md:px-8 py-4 flex gap-3 overflow-x-auto">
            {(Object.entries(modeLabels) as [RenderMode, any][]).map(
              ([m, { label, icon }]) => (
                <button
                  key={m}
                  onClick={() => setMode(m)}
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  placeholder="Enter image URL (or press Enter)"
              ...
              <div className="text-sm text-white/70 space-y-3">
                ...
                {mode === "4d" && (
                  <>
                    ...
                    <p>
                      ✨ Features: mouse-reactive distortion, breathing pulse,
                      dynamic color shifting, geometry waves, multi-light glow
                    </p>
                    <p>⚡ Premium product-level immersive experience</p>
                  </>
                )}
              </div>
            </div>
